...
"""
Splat implementation of Dynamic Gaussians 
"""
...
from nerfstudio.field_components.encodings import Encoding, NeRFEncoding, KPlanesEncoding
...
@dataclass
class DynamicSplatfactoModelConfig(ModelConfig):
...
class DynamicSplatfactoModel(Model):
    """Nerfstudio's implementation of Dynamic Gaussian Splatting

    Args:
        config: Splatfacto configuration to instantiate model
    """

    config: DynamicSplatfactoModelConfig
    ...
    def populate_modules(self):
        ...
        self.temporal_encoding: Encoding = NeRFEncoding(
